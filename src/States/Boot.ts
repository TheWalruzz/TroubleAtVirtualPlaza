module TAVP {
	export class Boot extends Phaser.State {
		...
		init() {
			...
			TAVP.Globals.pixel.canvas = Phaser.Canvas.create(
				<HTMLDivElement>document.getElementById('content'),
				this.game.width * TAVP.Globals.pixel.scale,
				this.game.height * TAVP.Globals.pixel.scale);
